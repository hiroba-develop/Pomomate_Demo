            ...
            <div className="flex items-center">
                ...
                <div className="ml-3 relative">
                  <div className="flex items-center">
                    ...
                    <button
                      ...
                      className="px-3 py-1 text-sm text-primary bg-white rounded hover:bg-gray-100"
                    >
                      ログアウト
                    </button>
                  </div>
              ...
              <div className="ml-3 md:hidden">
                <button
                  ...
                  className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-sub2 hover:bg-accent focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                >
                  ...
                  <Link
                    ...
                    className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${
                      location.pathname === item.path
                        ...
                        : "text-gray-600 hover:bg-sub1 hover:text-white"
                    }`}
                  >
                    {item.name}
                  </Link>
